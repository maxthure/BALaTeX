...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Box \phi_{1}) \label{eq:proofProp3.1.2.1.1} \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i \leq k \leq n \label{eq:proofProp3.1.2.1.2} \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i < n \text{ implies } \label{eq:proofProp3.1.2.1.3} \\
            &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i+1 \leq k \leq n) \nonumber \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i < n \text{ implies } \mathfrak{I}, i+1 \models \mathfrak{a}(\Box\phi_{1})) \label{eq:proofProp3.1.2.1.4} \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1} \wedge \CIRCLE \Box \phi_{1}) \label{eq:proofProp3.1.2.1.5}
        \end{align}
        \eqref{eq:proofProp3.1.2.1.3} is equivalent to \eqref{eq:proofProp3.1.2.1.2} because
        \begin{itemize}
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Diamond^{-} \phi_{1}) \label{eq:proofProp3.1.2.4.1} \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, 0 \leq k \leq i \label{eq:proofProp3.1.2.4.2} \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i > 0 \text{ and } \label{eq:proofProp3.1.2.4.3} \\
            &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, 0 \leq k \leq i-1) \nonumber \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i > 0 \text{ and } \mathfrak{I}, i-1 \models \mathfrak{a}(\Diamond^{-} \phi_{1})) \label{eq:proofProp3.1.2.4.4} \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1} \vee \Circle^{-} \Diamond^{-} \phi_{1}) \label{eq:proofProp3.1.2.4.5}
        \end{align}
        \eqref{eq:proofProp3.1.2.4.3} is equivalent to \eqref{eq:proofProp3.1.2.4.2} because
        \begin{itemize}
...
\begin{proof}
    ...
    \begin{proof}
        ...
        This is by induction equal to $Ans(\psi_{1}, \mathfrak{I}^{(n)},0)$ which then is, as shown in Proposition \ref{prop:3.1.2},
        equal to $\mathsf{Ans}(\psi, \mathfrak{I}^{(n)},0)$.\\
        If $\psi = \Box\psi_{1}$, then
        \begin{equation}
            \notag
            \label{eq:proofLemma3.1.5.1}
            \begin{split}
...
\label{sec:expansion/referencingVariables}
...
\label{sec:expansion/numericalpredicates}
\input{NumericalPredicates.tex}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i \leq k \leq n  \\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Box^{-} \phi_{1}) \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, 0 \leq k \leq i \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, i \leq k \leq n \\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Diamond^{-} \phi_{1}) \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, 0 \leq k \leq i \\

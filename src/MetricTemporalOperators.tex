...
\begin{definition}[semantics of temporal queries with metric temporal operators ct.\ Definition 3.3 in \cite{borgwardt2015temporalizing}]
    ...
    \begin{table}[H]
        ...
        \end{tabular*}
        \caption{satisfaction relation of TQs with MTOs}
...
\begin{proof}
    ...
    The missing cases work similar AND CAN BE FOUND IN THE APPENDIX \ref{ch:appendixC}.
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \end{align}
        \eqref{eq:extension/metrictemporaloperators/proofProp3/eq5.3} is equivalent to \eqref{eq:extension/metrictemporaloperators/proofProp3/eq5.2} because
        \begin{itemize}
        ...
        \end{align}
        \eqref{eq:extension/metrictemporaloperators/proofProp3/eq7.3} is equivalent to \eqref{eq:extension/metrictemporaloperators/proofProp3/eq7.2} because
        \begin{itemize}
        ...
        \end{align}
        \eqref{eq:extension/metrictemporaloperators/proofProp3/eq8.3} is equivalent to \eqref{eq:extension/metrictemporaloperators/proofProp3/eq8.2} because
        \begin{itemize}
        ...
        \end{align}
        \eqref{eq:extension/metrictemporaloperators/proofProp3/eq10.3} is equivalent to \eqref{eq:extension/metrictemporaloperators/proofProp3/eq10.2} because
        \begin{itemize}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\mathsf{eval}^{n}(\alpha)$ with MTOs}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\Phi^{0}_{i}(\psi)$ with MTOs}
...
without MTOs $\mathsf{Sub}(\phi) = \{\phi, \Circle^{-}\Circle^{-}\Circle^{-}\Circle^{-}\Circle^{-} \psi,
\Circle^{-}\Circle^{-}\Circle^{-}\Circle^{-} \psi, \Circle^{-}\Circle^{-}\Circle^{-} \psi, \Circle^{-}\Circle^{-} \psi, \Circle^{-} \psi, \psi\}$
and with MTOs $\mathsf{Sub}(\phi) = \{\phi, \Diamond^{-}_{5} \psi, \Diamond^{-}_{4} \psi, \Diamond^{-}_{3} \psi, \Diamond^{-}_{2} \psi, \Diamond^{-}_{1} \psi, \Diamond^{-}_{0} \psi\}$.

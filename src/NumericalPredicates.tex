...
\begin{definition}[semantics of temporal queries with numerical predicates ct.\ Definition 3.3 in \cite{borgwardt2015temporalizing}]
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align}
            ...
            \Leftrightarrow &i + p \leq n \text{ and }\mathfrak{I}, i+p \models \mathfrak{a}(\phi_{1}) \\
            \Leftrightarrow & i < n\text{ and }(i+1)+(p-1) \leq n \text{ and }\mathfrak{I}, (i+1)+(p-1) \models \mathfrak{a}(\phi_{1}) \\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\CIRCLE_{p} \phi_{1}) \\
            \Leftrightarrow &i + p \leq n \text{ implies }\mathfrak{I}, i+p \models \mathfrak{a}(\phi_{1}) \\
            \Leftrightarrow & i < n\text{ implies }(i+1)+(p-1) \leq n \text{ implies }\mathfrak{I}, (i+1)+(p-1) \models \mathfrak{a}(\phi_{1}) \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &i - p \geq 0 \text{ and }\mathfrak{I}, i-p \models \mathfrak{a}(\phi_{1}) \\
            \Leftrightarrow & i > 0\text{ and }(i-1)-(p-1) \geq 0 \text{ and }\mathfrak{I}, (i-1)-(p-1) \models \mathfrak{a}(\phi_{1}) \\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\CIRCLE^{-}_{p} \phi_{1}) \\
            \Leftrightarrow &i - p \geq 0 \text{ implies }\mathfrak{I}, i-p \models \mathfrak{a}(\phi_{1}) \\
            \Leftrightarrow & i > 0\text{ implies }(i-1)-(p-1) \geq 0 \text{ implies }\mathfrak{I}, (i-1)-(p-1) \models \mathfrak{a}(\phi_{1}) \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i \leq k \leq \mathsf{min}(i+p,n) \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i < n \text{ implies } \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, \mathsf{max}(i-p,0) \leq k \leq i \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i > 0 \text{ implies } \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, i \leq k \leq \mathsf{min}(i+p,n) \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i < n \text{ and } \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, \mathsf{max}(i-p,0) \leq k \leq i \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i > 0 \text{ and } \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\text{there is } k, i \leq k \leq \mathsf{min}(i+p,n)\text{, with } \mathfrak{I}, k \models \mathfrak{a}_{\phi_{2}}(\phi_{2}) \text{ and } \\
            &\mathfrak{I}, j \models \mathfrak{a}_{\phi_{1}}(\phi_{1})\text{ for all }j, i \leq j < k \nonumber \\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\text{there is } k, \mathsf{max}(i-p,0) \leq k \leq i\text{, with } \mathfrak{I}, k \models \mathfrak{a}_{\phi_{2}}(\phi_{2}) \text{ and } \\
            &\mathfrak{I}, j \models \mathfrak{a}_{\phi_{1}}(\phi_{1})\text{ for all }j, k < j \leq i \nonumber \\
...
The semantics of the operators with numerical predicates can now be used to extend the algorithm specified in \cite{borgwardt2015temporalizing}.
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\mathsf{eval}^{n}(\alpha)$ with numerical predicates}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\Phi_{0}(\psi)$ with numerical predicates}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\Phi^{0}_{i}(\psi)$ with numerical predicates}

\end{table}

\begin{theorem}

    Extending the bounded history encoding from \cite{borgwardt2015temporalizing} by numerical predicates, preserves correctness and boundedness.
\end{theorem}
...
\begin{proof}
    ...
    \begin{lemma}[ct.\ Lemma 6.3 in \cite{borgwardt2015temporalizing}]
        The function $\Phi_{0}$ with numerical predicates is correct for 0.
    \end{lemma}
    ...
    \begin{lemma}[ct.\ Lemma 6.4 in \cite{borgwardt2015temporalizing}]
        If $\Phi_{i-1}$ with numerical predicates is correct for i-1, then $\Phi^{0}_{i}$ with numerical predicates is correct for i.
    \end{lemma}
    ...
    \begin{lemma}[ct.\ Lemma 6.5 in \cite{borgwardt2015temporalizing}]
        If $\Phi_{i-1}$ with numerical predicates is correct for i-1 and (i-1)-bounded, then we can construct a function $\Phi_{i}: \mathsf{Sub}(\phi)
        \rightarrow \mathsf{AT}^{i}_{\phi}$ with numerical predicates that is correct for i and i-bounded.
    \end{lemma}
    ...
    \begin{proof}
        ...
        For operators with numerical predicates, $\mathsf{update}(x^{\psi^{j}}_{i-1})$ looks like this:
        \begin{equation}
            \notag
            \label{bla}
            \begin{split}

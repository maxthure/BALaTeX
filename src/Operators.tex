\chapter{Extensions}
\label{ch:extension}
It became clear that both the language from \cite{borgwardt2015temporalizing} and consequently the implementation of the BHE \cite{borgwardt2015temporalizing}
must be extended in order to provide relevant answers to the PTQs specified in Chapter \ref{ch:queries}.
...
\begin{proof}
    ...
    The other two cases work similar AND CAN BE FOUND IN THE APPENDIX \ref{ch:appendixC}.
    ...
    \begin{enumerate}
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1} \wedge \CIRCLE^{-} \Box^{-} \phi_{1})
        \end{align}
        \eqref{eq:extension/operatorsnotimplemented/proofProp2/eq2.3} is equivalent to \eqref{eq:extension/operatorsnotimplemented/proofProp2/eq2.2} because
        \begin{itemize}
        ...
        \end{align}
        \eqref{eq:extension/operatorsnotimplemented/proofProp2/eq3.3} is equivalent to \eqref{eq:extension/operatorsnotimplemented/proofProp2/eq3.2} because
        \begin{itemize}

...
\begin{document}
    ...
    In this chapter we will extend the algorithm presented in \cite{borgwardt2015temporalizing} by the operators
    \(\Box \phi\) (always), \(\Box^{-} \phi\) (always in the past), \(\Diamond \phi\) (eventually), \(\Diamond^{-} \phi\)
    (some time in the past) that were already presented in the paper but not considered when defining the algorithm.
    We are extending the algorithm because these operators are necessary for a lot of relevant queries.
    First we will show how to modify the definitions of \(\mathsf{eval}^{n}(\alpha)\), \(\Phi_{0}(\psi)\) and \(\Phi_{i}(\psi)\),
    before we will continue to prove why the modifications are correct.
    As a reminder the semantics of these four temporal queries (TQs) are defined as follows:
    \begin{definition}[semantics of TQs cf.\ Definition 3.3 in \cite{borgwardt2015temporalizing}]
    ...
    As in \cite{borgwardt2015temporalizing}, we can show that
    \begin{itemize}
    ...
    \end{itemize}
    Because of the way \(\Box\) is defined in \cite{borgwardt2015temporalizing} we have to use \(\CIRCLE\) instead of
    ...
    \begin{itemize}
        ...
        \item \(\Diamond^{-} \phi_{1}\) is equivalent to \(\phi_{1} \vee \Circle^{-} \Diamond^{-} \phi_{1}\) .
    \end{itemize}
    Analogously to the reason as mentioned above we have to use \(\CIRCLE^{-}\) instead of \(\Circle^{-}\)
    ...
    \begin{proposition}[similar\ to\ Proposition 3.4 in \cite{borgwardt2015temporalizing}]
        ...
        \begin{enumerate}
            ...
            \end{itemize}
            %Furthermore, \(\mathfrak{I}, n \models \mathfrak{a}(\Box \phi_{1})\) iff \(\mathfrak{I}, n \models \mathfrak{a}(\phi_{1})\)
            \item \(\mathfrak{I}, i \models \mathfrak{a}(\Box^{-} \phi_{1})\) iff
            \begin{itemize}
                \item \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1})\) and
                \item \(i > 0\) implies \(\mathfrak{I}, i-1 \models \mathfrak{a}(\Box^{-} \phi_{1})\)
            \end{itemize}
            %Furthermore, \(\mathfrak{I}, 0 \models \mathfrak{a}(\Box^{-} \phi_{1})\) iff \(\mathfrak{I}, 0 \models \mathfrak{a}(\phi_{1})\)
            ...
            \end{itemize}
            %Furthermore, \(\mathfrak{I}, n \models \mathfrak{a}(\Diamond \phi_{1})\) iff \(\mathfrak{I}, n \models \mathfrak{a}(\phi_{1})\)
            \item \(\mathfrak{I}, i \models \mathfrak{a}(\Diamond^{-} \phi_{1})\) iff
            \begin{itemize}
                \item \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1})\) or
                \item \(i > 0\) and \(\mathfrak{I}, i-1 \models \mathfrak{a}(\Diamond^{-} \phi_{1})\)
            \end{itemize}
            %Furthermore, \(\mathfrak{I}, 0 \models \mathfrak{a}(\Diamond^{-} \phi_{1})\) iff \(\mathfrak{I}, 0 \models \mathfrak{a}(\phi_{1})\)
        \end{enumerate}
    \end{proposition}

    ANNOTATION: CASES 1 AND 4 MAY BE SUFFICIENT

    \begin{proof}

        To prove the above proposition we will prove each equivalence.
        We will mainly show this on the basis of the semantics.
        \begin{enumerate}
            ...
            \begin{align}
                ...
                &\Leftrightarrow \mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } i < n \text{ implies } \mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i+1 \leq k \leq n \label{proof1.1.3} \\
            ...
            \end{align}
            \eqref{proof1.1.3} is equivalent to \eqref{proof1.1.2} because for \(i < n\) in order to contain an answer the query needs to be satisfied now
            (at time point i) as well as at all future time points \((i+1 \leq k \leq n)\).
            Since \(i < n\) is true the satisfaction of future time points solely depends on the second part of the
            "implies"-statement.
            In the case of \(i = n\) this is equivalent as well because \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \Leftrightarrow \mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\)
            for all \(k, n \leq k \leq n\) and \(i < n\) is not true.
            ...
            \begin{align}
                ...
                &\Leftrightarrow \mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } i > 0 \text{ implies } \mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, 0 \leq k \leq i-1 \label{proof1.2.3} \\
            ...
            \end{align}
            \eqref{proof1.2.3} is equivalent to \eqref{proof1.2.2} because for \(i > 0\) in order to contain an answer the query needs to be satisfied now
                (at time point i) as well as at all past time points \((0 \leq k \leq i-1)\).
                Since \(i > 0\) is true the satisfaction of past time points solely depends on the second part of the
                "implies"-statement.
                In the case of \(i = 0\) this is equivalent as well because \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \Leftrightarrow \mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\)
                for all \(k, 0 \leq k \leq 0\) and \(i > 0\) is not true.
            ...
            \begin{align}
                ...
                &\Leftrightarrow \mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } i < n \text{ and } \mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, i+1 \leq k \leq n \label{proof1.3.3} \\
            ...
            \end{align}
            \eqref{proof1.3.3} is equivalent to \eqref{proof1.3.2} because for \(i < n\) in order to contain an answer the query needs to be satisfied now
                (at time point i) or at one future time point \((i+1 \leq k \leq n)\).
                Since \(i < n\) is true the satisfaction of future time points solely depends on the second part of the
                "implies"-statement.
                In the case of \(i = n\) this is equivalent as well because \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \Leftrightarrow \mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\)
                for all \(k, n \leq k \leq n\) and \(i < n\) is not true but \(\mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\) for some \(k, n+1 \leq k \leq n\)
                does not hold either, so we do not lose any answers.
            ...
            \begin{align}
                ...
                &\Leftrightarrow \mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } i > 0 \text{ and } \mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, 0 \leq k \leq i-1 \label{proof1.4.3} \\
            ...
            \end{align}
            \eqref{proof1.4.3} is equivalent to \eqref{proof1.4.2} because for \(i > 0\) in order to contain an answer the query needs to be satisfied now
                (at time point i) or at any past time point \((0 \leq k \leq i-1)\).
                Since \(i > 0\) is true the satisfaction of past time points solely depends on the second part of the
                "implies"-statement.
                In the case of \(i = 0\) this is equivalent as well because \(\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \Leftrightarrow \mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\)
                for some \(k, 0 \leq k \leq 0\) and \(i > 0\) is not true but \(\mathfrak{I}, k \models \mathfrak{a}(\phi_{1})\) for some \(k, 0 \leq k \leq 0-1\)
                does not hold either, so we do not lose any answers.

        \end{enumerate}
    \end{proof}

    The semantics of the four queries can be used now to extend the algorithm given in \cite{borgwardt2015temporalizing}.
    For that we need the notation of \(answer\ terms\).
    We use the same simplification and assume in the following that \(\mathsf{N}_{\mathsf{V}}\), the set of \(variables\), is finite
    and that answers are of the form \(\mathfrak{a}:\mathsf{N}_{\mathsf{V}} \rightarrow \Delta\) instead of \(\mathfrak{a}:\mathsf{FVar}(\phi) \rightarrow \Delta\).
    ...
    The function \(\Phi_{0}(\psi): \mathsf{Sub}(\phi) \rightarrow \mathsf{AT}^{0}_{\phi}\) in \cite{borgwardt2015temporalizing} has to be expanded as follows:
    \begin{table}[H]
        \centering
        \begin{tabular*}{\textwidth}{@{}ll@{}}
            \toprule
    ...
    To prove that correctness and boundedness of the algorithm is preserved we will add the necessary cases to the
    ...
    \begin{proof}
        We show by induction on the structure of the subqueries \(\psi \in \mathsf{Sub}(\phi)\) that \(\mathsf{eval}^{n}(\Phi_{0}(\psi))\)
    ...
    \begin{proof}
        We show by induction on the structure of the subqueries \(\psi \in \mathsf{Sub}(\phi)\) that \(\mathsf{eval}^{n}(\Phi^{0}_{i}(\psi))\)
    ...
    \begin{proof}
        We need to expand the introduced function \(\mathsf{update}(x^{\psi^{j}}_{i-1})\) before then showing for all \(n \geq i\) that

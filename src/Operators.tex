\chapter{Expansion of the BHE ACHTUNG NICHT FERTIG}
\label{ch:expansion}
...
\label{sec:expansion/operatorsnotimplemented}
...
\begin{definition}[semantics of temporal queries ct.\ Definition 3.3 in \cite{borgwardt2015temporalizing}]
    \label{def:expansion/operatorsnotimplemented/semantics}
    ...
    \begin{table}[H]
        ...
        \end{tabular*}
        \caption{semantics of TQs $\Box, \Box^{-}, \Diamond$ and $\Diamond^{-}$}
        \label{tab:expansion/operatorsnotimplemented/satisfactionrelation}
    \end{table}
...
\begin{proposition}[ct.\ Proposition 3.4 in \cite{borgwardt2015temporalizing}]
    \label{prop:expansion/operatorsnotimplemented/prop2}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i \leq k \leq n  \label{eq:expansion/operatorsnotimplemented/proofProp2/eq1.2} \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i < n \text{ implies } \label{eq:expansion/operatorsnotimplemented/proofProp2/eq1.3}\\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Box^{-} \phi_{1}) \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, 0 \leq k \leq i \label{eq:expansion/operatorsnotimplemented/proofProp2/eq2.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i > 0 \text{ implies } \label{eq:expansion/operatorsnotimplemented/proofProp2/eq2.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, i \leq k \leq n \label{eq:expansion/operatorsnotimplemented/proofProp2/eq3.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i < n \text{ and } \label{eq:expansion/operatorsnotimplemented/proofProp2/eq3.3}\\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\Diamond^{-} \phi_{1}) \\
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, 0 \leq k \leq i \label{eq:expansion/operatorsnotimplemented/proofProp2/eq4.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i > 0 \text{ and } \label{eq:expansion/operatorsnotimplemented/proofProp2/eq4.3}\\
...
\begin{definition}[answer\ term ct.\ Definition 6.1 in \cite{borgwardt2015temporalizing}]
    \label{def:expansion/operatorsnotimplemented/answerterm}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\mathsf{eval}^{n}(\alpha)$ for $\Box, \Box^{-}, \Diamond$ and $\Diamond^{-}$}
    \label{tab:expansion/operatorsnotimplemented/eval}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\Phi_{0}(\psi)$ for $\Box, \Box^{-}, \Diamond$ and $\Diamond^{-}$}
    \label{tab:expansion/operatorsnotimplemented/phi0}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular*}
    \caption{$\Phi^{0}_{i}(\psi)$ for $\Box, \Box^{-}, \Diamond$ and $\Diamond^{-}$}
    \label{tab:expansion/operatorsnotimplemented/phiI}
\end{table}
$\mathsf{Sub}(\phi)$ denotes the set of all TQs occurring as temporal subqueries in $\phi$ (including $\phi$ itself).

\begin{theorem}
    \label{th:expansion/operatorsnotimplemented/corretandbounded}
...
\begin{proof}
    ...
    \begin{lemma}[ct.\ Lemma 6.3 in \cite{borgwardt2015temporalizing}]
        \label{lem:expansion/operatorsnotimplemented/lemma5}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma5/eq1}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma5/eq2}
            \begin{split}
    ...
    \begin{lemma}[ct.\ Lemma 6.4 in \cite{borgwardt2015temporalizing}]
        \label{lem:expansion/operatorsnotimplemented/lemma6}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma6/eq1}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma6/eq2}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma6/eq3}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma6/eq4}
            \begin{split}
    ...
    \begin{lemma}[ct.\ Lemma 6.5 in \cite{borgwardt2015temporalizing}]
        \label{lem:expansion/operatorsnotimplemented/lemma7}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \notag
            \label{eq:expansion/operatorsnotimplemented/proofLemma7/eq1}
            \begin{split}
...
\section{Filtering of query results}
\label{sec:expansion/filtering}
\input{QueryFiltering.tex}

\section{Metric Temporal Operators}
\label{sec:expansion/metrictemporaloperators}

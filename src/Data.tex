...
To create a real discrete data stream, we collect the data weekly for ten weeks.
...
In order to check whether this affects the research result, the result of the bounded history encoding from \cite{borgwardt2015temporalizing}, applied to weekly collected data, is compared to the result of the bounded history encoding from \cite{borgwardt2015temporalizing}, applied to daily collected data.

Third, the algorithm presented in \cite{borgwardt2015temporalizing} is extended by metric temporal operators.
...
The semantics of TQs from Definition REF DEFINITION TQ are extended as follows:
\begin{definition}[semantics of temporal queries with metric temporal operators ct.\ Definition 3.3 in \cite{borgwardt2015temporalizing}]
    ...
    \begin{table}[H]
        ...
        \end{tabular*}
        \caption{satisfaction relation of TQs with metric temporal operators}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\CIRCLE_{p} \phi_{1}) \\
            \Leftrightarrow &i + p \leq n \text{ implies }\mathfrak{I}, i+p \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq2.2}\\
            \Leftrightarrow & i < n\text{ implies }(i+1)+(p-1) \leq n \text{ implies }\mathfrak{I}, (i+1)+(p-1) \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq2.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &i - p \geq 0 \text{ and }\mathfrak{I}, i-p \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq3.2}\\
            \Leftrightarrow & i > 0\text{ and }(i-1)-(p-1) \geq 0 \text{ and }\mathfrak{I}, (i-1)-(p-1) \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq3.3}\\
        ...
        \begin{align}
            &\mathfrak{I}, i \models \mathfrak{a}(\CIRCLE^{-}_{p} \phi_{1}) \\
            \Leftrightarrow &i - p \geq 0 \text{ implies }\mathfrak{I}, i-p \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq4.2}\\
            \Leftrightarrow & i > 0\text{ implies }(i-1)-(p-1) \geq 0 \text{ implies }\mathfrak{I}, (i-1)-(p-1) \models \mathfrak{a}(\phi_{1}) \label{eq:extension/metrictemporaloperators/proofProp3/eq4.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for all } k, i \leq k \leq \mathsf{min}(i+p,n) \label{eq:extension/metrictemporaloperators/proofProp3/eq5.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ and } (i < n \text{ implies } \label{eq:extension/metrictemporaloperators/proofProp3/eq5.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, i \leq k \leq \mathsf{min}(i+p,n) \label{eq:extension/metrictemporaloperators/proofProp3/eq7.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i < n \text{ and } \label{eq:extension/metrictemporaloperators/proofProp3/eq7.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\mathfrak{I}, k \models \mathfrak{a}(\phi_{1}) \text{ for some } k, \mathsf{max}(i-p,0) \leq k \leq i \label{eq:extension/metrictemporaloperators/proofProp3/eq8.2}\\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}(\phi_{1}) \text{ or } (i > 0 \text{ and } \label{eq:extension/metrictemporaloperators/proofProp3/eq8.3}\\
        ...
        \begin{align}
            ...
            \Leftrightarrow &\text{there is } k, \mathsf{max}(i-p,0) \leq k \leq i\text{, with } \mathfrak{I}, k \models \mathfrak{a}_{\phi_{2}}(\phi_{2}) \text{ and } \label{eq:extension/metrictemporaloperators/proofProp3/eq10.2}\\
            &\mathfrak{I}, j \models \mathfrak{a}_{\phi_{1}}(\phi_{1})\text{ for all }j, k < j \leq i \nonumber \\
            \Leftrightarrow &\mathfrak{I}, i \models \mathfrak{a}_{\phi_{2}}(\phi_{2})\text{ or }(\mathfrak{I}, i \models \mathfrak{a}_{\phi_{1}}(\phi_{1})\text{ and }(i > 0\text{ and } \label{eq:extension/metrictemporaloperators/proofProp3/eq10.3}\\
...
The semantics of the metric temporal operators can now be used to extend the algorithm specified in \cite{borgwardt2015temporalizing}.
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma5/eq2}
            \begin{split}
                \(\mathsf{eval}^{n}(\Phi_{0}(\psi)) &= \mathsf{eval}^{n}(x^{\CIRCLE_{p} \psi_{1}}_{0}) \\
                &= \left\{\begin{array}{lr}
                              \mathsf{Ans}(\CIRCLE_{p-1} \psi_{1}, \mathfrak{I}^{(n)},1) & \text{if } n > 0\\
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma5/eq4}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma5/eq6}
            \begin{split}
                \(\mathsf{eval}^{n}(\Phi_{0}(\psi)) &= \mathsf{eval}^{n}(\Phi_{0}(\psi_{2})) \\
    ...
    \begin{proof}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq4}
            \begin{split}
                \(\mathsf{eval}^{n}(\Phi^{0}_{i}(\psi)) &= \mathsf{eval}^{n}(x^{\CIRCLE_{p} \psi_{1}}_{i}) \\
                &= \left\{\begin{array}{lr}
                              \mathsf{Ans}(\CIRCLE_{p-1} \psi_{1}, \mathfrak{I}^{(n)},i+1) & \text{if } n > i\\
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq5}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq6}
            \begin{split}
                \(\mathsf{eval}^{n}(\Phi^{0}_{i}(\psi)) &= \mathsf{eval}^{n}(\Phi_{i-1}(\CIRCLE^{-}_{p-1} \psi_{1})) \\
                &= \left\{\begin{array}{lr}
                              \mathsf{Ans}(\CIRCLE^{-}_{p-1} \psi_{1}, \mathfrak{I}^{(n)},i-1) & \text{if } i > 0\\
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq7}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq9}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq10}
            \begin{split}
        ...
        \begin{equation}
            \notag
            \label{eq:extension/metrictemporaloperators/proofLemma6/eq12}
            \begin{split}

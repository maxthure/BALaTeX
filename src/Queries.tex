...
\label{sec:queries/queriesforinvestigation}
...
\label{subsec:queries/queriesforinvestigation/practicalTQ}
...
A COMPLETE LIST OF PTQs CAN BE FOUND IN THE APPENDIX.

\subsection{Randomized TQs}
\label{subsec:queries/queriesforinvestigation/randomTQ}
...
A COMPLETE LIST OF GENERATED RTQs CAN BE FOUND IN THE APPENDIX.


\section{Are these queries expressible in the language from \cite{borgwardt2015temporalizing}?}
\label{sec:queries/queriesexpressibility}

\subsection{Practical TQs}
\label{subsec:queries/queriesexpressibility/practicalTQ}
...
\subsection{Randomized TQs}
\label{subsec:queries/queriesexpressibility/randomTQ}
